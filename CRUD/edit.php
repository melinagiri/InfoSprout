        ...
        <tr>
            <td>
                ...
                <select name="city">
                    ...
                    <option value="ktm"<?php if($f['city']=='knp'){ echo "selected='selected'";}?>>Kathmandu</option>
                    <option value="ltr"<?php if($f['city']=='lko'){ echo "selected='selected'";}?>>Lalitpur</option>
                    <option value="other"<?php if($f['city']=='lko'){ echo "selected='selected'";}?>>Other</option>
            </td>
        </tr>
        <tr>
            <td>
